...
public:
	...
	bool SetShaderParameters2(ID3D11DeviceContext* context, DirectX::SimpleMath::Matrix* world, DirectX::SimpleMath::Matrix* view, DirectX::SimpleMath::Matrix* projection, Light* sceneLight1,float paddingg, ID3D11ShaderResourceView* texture1, ID3D11ShaderResourceView* texture2);
